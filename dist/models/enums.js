...
(function (PaymentStatus) {
    PaymentStatus["prepare"] = "prepare";
    PaymentStatus["settled"] = "settled";
    PaymentStatus["pending"] = "pending";
    PaymentStatus["require3ds"] = "require3ds";
    PaymentStatus["redirect"] = "redirect";
    PaymentStatus["decline"] = "decline";
 ...
 */
export function stringToStatus(status) {
    switch (status) {
        case 'prepare':
